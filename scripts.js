...
function expenseAdd(newExpense){
  try {
    ...
    // Adiciona <strong> e <span> na div com class="expense-info".
    ...
    // Chama a função que irá atualizar os totais.
    updateTotals()
...
function updateTotals(){
  try {
    ...
    // Formata o valor e remoce o R$ que será exibido pela small com um estilo customizado.
